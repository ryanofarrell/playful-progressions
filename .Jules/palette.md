...
### 2026-07-29 — Redundant image link accessibility
- **Target:** `_layouts/post.html`
- **Finding:** Related post image link was redundant with the title link, causing repetitive tab stops and screen reader announcements.
- **Action:** Added `aria-hidden="true"` and `tabindex="-1"` to the image link to remove unnecessary tab stops and repetitive screen reader announcements.
