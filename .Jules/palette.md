...
### 2026-08-05 — Removed redundant tab stops on related posts cards
- **Target:** `_layouts/post.html`
- **Finding:** Related post cards had both the image and the title wrapped in identical links, creating redundant tab stops and screen reader announcements.
- **Action:** Added `aria-hidden="true"` and `tabindex="-1"` to the image links.
