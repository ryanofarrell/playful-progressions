...
- [✅] `2025-05-30-basics-motor-planning.md` (2026-07-29)
...
## 2026-07-29 — Added missing description and fixed tags formatting in front matter
- **Target:** `_posts/2025-05-30-basics-motor-planning.md`
- **Finding:** The post was missing the required `description` field for SEO, and the `tags` property was incorrectly formatted as a singular string.
- **Action:** Added a 143-character `description` and updated `tag: Posts` to `tags: ["Posts"]`.
