...
- [ ] `2025-05-30-basics-motor-planning.md` - 2026-07-15 (Front matter fixed; structure audit pending)
...
## 2026-07-15 — Fix front matter issues in Basics of Motor Planning post
- **Target:** `_posts/2025-05-30-basics-motor-planning.md`
- **Finding:** Missing description, invalid tags format, too many/invalid concepts, title too long, and incorrect image paths.
- **Action:** Updated front matter fields to match required schema, pointing image fields to correctly existing files.
